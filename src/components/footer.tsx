...
export const Footer = () => {
  ...
  return (
    <footer className="relative bg-white border-t border-zinc-200">
      {/* subtle top hairline */}
      <div className="absolute inset-x-0 top-0 h-px pointer-events-none bg-gradient-to-r from-transparent via-zinc-300 to-transparent" />

      <div className="px-4 py-10 mx-auto max-w-7xl sm:px-6 lg:px-8 md:py-12">
        {/* Top content */}
        <div className="grid items-start grid-cols-1 gap-10 md:grid-cols-3 md:gap-8">
          {/* Logos */}
          <div className="flex items-center gap-4 sm:gap-6 md:col-span-2">
            <img
              src="/logo.png"
              alt="The Box Castellón"
              className="w-auto h-auto max-w-full max-h-14 sm:max-h-24 md:max-h-28 lg:max-h-32 shrink-0"
            />
            <p>&</p>
            {/* Partner logo (optional) */}
            <img
              src="/hymove.png"
              alt="HyMove Entrenamiento Funcional e Híbrido"
              className="object-contain w-auto h-auto max-w-full max-h-9 lg:max-h-12 opacity-95"
            />
            {/* <img
              src="/infinitum.jpg"
              alt="Infinitum Salud"
              className="object-contain w-auto h-auto max-w-full max-h-16 lg:max-h-24 opacity-95"
            /> */}
          </div>

          {/* Contacto */}
          <div className="text-zinc-700 md:col-span-2">
            <h3 className="text-base font-semibold sm:text-lg text-emerald-800">
              Contacto
            </h3>
            <ul className="mt-3 space-y-2 text-sm sm:text-base">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="break-words hover:text-emerald-800"
                >
          ...
          <div className="text-zinc-700 md:col-span-1">
            ...
            <address className="mt-3 text-sm not-italic leading-relaxed sm:text-base">
        ...
        {/* Bottom bar */}
        <div className="flex flex-col gap-4 pt-6 mt-10 border-t border-zinc-200 md:flex-row md:items-center md:justify-between">
          ...
          <p className="text-sm text-center md:text-right text-zinc-600">
